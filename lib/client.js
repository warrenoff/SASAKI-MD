...
try {
    ...
    console.log("Could not connect with Mongodb please provide me")
    process.exit(0)
}
...
let cc = Config.sessionName.replace('SASAKI&', '');
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const Void = VoidConnect({
            ...
            browser: ['TOGE-MD-V2', 'safari', '1.0.0'],
